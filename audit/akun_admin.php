        ...
        <div class="card">
              ...
              <table id="example1" class="table table-striped">
                  ...
                  <?php 
                      include('koneksi.php');
                      $no = 1;
                      $query = mysqli_query($connection,"SELECT * FROM user WHERE status='admin'");
                  ...
                  <tr>
                      ...
                      <td width="100px" class="text-center">
                        <a href="edit_admin.php?id=<?php echo $row['username'] ?>" class="btn btn-icon fas fa-edit btn-sm btn-info"></a>
                        <a href="hapus_admin.php?id=<?php echo $row['username'] ?>" class="btn-icon fas fa-trash btn-sm btn-secondary" onclick="return checkDelete()"></a>
                      </td>
