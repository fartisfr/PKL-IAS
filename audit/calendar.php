...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.1/index.global.min.js" rel="stylesheet">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      Swal.fire({
        ...
        html: '<p><br/>Audit Job : '+info.event.extendedProps.auditjob+'</p><p></br/>Start Date : '+info.event.extendedProps.startdate+'</p></br/>Target Date : '+info.event.extendedProps.startdate+'</p>',
      });
      }
    });
