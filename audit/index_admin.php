      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <?php 
            ...
            $query = "SELECT COUNT(*) AS jumlah FROM user WHERE status='admin' ";
            $result = $connection->query($query);
            $jumlahadm = $result->fetch_object()->jumlah;

            $query = "SELECT COUNT(*) AS jml FROM user WHERE status='user'";
            $result = $connection->query($query);
            $jumlahuser = $result->fetch_object()->jml;

            $query = "SELECT COUNT(*) AS jmlakun FROM user";
            $result = $connection->query($query);
            $jumlahakun = $result->fetch_object()->jmlakun;

            $query = "SELECT COUNT(*) AS jmlplan FROM auditplan";
            $result = $connection->query($query);
            $jumlahplan = $result->fetch_object()->jmlplan;
          ?>
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="./akun_admin.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="./akun_user.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p>Jumlah Total Akun Aktif</p>
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
              <a href="./add_admin_user.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <p>Jumlah Audit Plan</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <a href="./auditplan.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
