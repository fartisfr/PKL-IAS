...
<head>
  ...
  function changeStatus(kode, event){
    ...
    const xhr = new XMLHttpRequest();
            xhr.open('POST', 'update_status_auditplan.php', true);
            xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
            xhr.onload = function() {
                console.log(this.responseText);
            }
            xhr.send(`kode=${kode}&status=${val}`);
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
              ...
              <a href="./add_auditplan.php" class="btn btn-md btn-success" style="margin-bottom: 10px">ADD PLAN</a>  
              <a target='_blank' href="./print_auditplan.php" class="btn btn-md btn-primary" style="margin-bottom: 10px">PRINT</a>
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <td><select name="status" id="status" onchange="changeStatus('<?= $row['kode'] ?>', event)">
                          <option value="Plan" <?php echo $row['status'] == "Plan" ? "selected" : "" ?>>Plan</option>
                          <option value="Running" <?php echo $row['status'] == "Running" ? "selected" : "" ?>>Running</option>
                          <option value="Done" <?php echo $row['status'] == "Done" ? "selected" : "" ?>>Done</option>
                        </select></td>
                        
                        <td width="80px" class="text-center">
                          <a href="./edit_auditplan.php?id=<?php echo $row['kode'] ?>" class="btn btn-icon fas fa-edit btn-sm btn-info" ></a>
                          <a href="./hapus_auditplan.php?id=<?php echo $row['kode'] ?>" class="btn-icon fas fa-trash btn-sm btn-secondary" onclick="return checkDelete()"></a>
                        </td>
                  </tr>
